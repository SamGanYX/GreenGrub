...
public class OpenFood {
    ...
    public static class Product {
        ...
        public void setEcoscoreData(EcoscoreData ecoscoreData) {
    ...
    public static class EcoscoreData {
        ...
        public static class Agribalyse {
            ...
            public String getCo2TotalUnit() {
                return co2TotalUnit;
            }

            public void setCo2TotalUnit(String co2TotalUnit) {
                this.co2TotalUnit = co2TotalUnit;
            }
        }
    }
}
